...
public class Inbox extends AppCompatActivity {
    ...
    ArrayList<Mail> arrayMails=new ArrayList<>();
...
//        --------------------------------------------------------------------------
       ...
       // progressBar.setVisibility(View.VISIBLE);
        ...
        //customAdapter=new CustomAdapter(arrayMails,this);
        ...
        //Toast.makeText(Inbox.this, currentUser.replace("@spamshoot.com",""), Toast.LENGTH_SHORT).show();
         dref= FirebaseDatabase.getInstance().getReference().child("Users").child(currentUser.replace("@spamshoot.com","")).child("mails").child("inbox");
...
//
//                }
//                //arrayList.add(dataSnapshot.getValue(Mail.class).getMessage());
//                adapter.notifyDataSetChanged();
//                progressBar.setVisibility(View.INVISIBLE);
//            }
//

...
//        final ArrayAdapter<String> adapter=new ArrayAdapter<String>(this,R.layout.mylist,R.id.Itemname,arrayList);
        ...
        dref= FirebaseDatabase.getInstance().getReference().child("Users").child(currentUser.replace("@spamshoot.com","")).child("mails").child("spam");
...
//                Toast.makeText(Spam.this,arrayList.get(i),Toast.LENGTH_LONG).show();
//
//                return true;
//            }
//        });
